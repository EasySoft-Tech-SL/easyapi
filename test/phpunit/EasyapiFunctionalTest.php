...
/**
 * \file    test/phpunit/EasyapiFunctionalTest.php
 * \ingroup easyapi
 ...
 * @package Testeasyapi
 */
class EasyapiFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 9534852; // TODO: autodetect?
	...
	{
		$this->url('/custom/easyapi/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('easyapi/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/easyapi/admin/about.php');
		$this->authenticate();
		return $this->assertContains('easyapi/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('easyapiwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEasyapi_EasyapiTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEasyapi_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
